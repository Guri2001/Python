...
for data_point in daily_transactions_split:
  for in_data_point in data_point:
    transactions_clean.append(in_data_point.strip())
...
for each_colour in colours:
  print("Thread Shed sold {colour} threads of {each_colour} thread today.".format(colour = colour_count(each_colour), each_colour= each_colour))
